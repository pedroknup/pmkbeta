...
export default class Config {
  static constants() {
    return {
      ...
      logging_level: 1, // 0=silly,1=verbose,2=info, 3 = warning, 4 = error. anything higher than 5 = off. see logger.js
      error_messages: {
        EHOSTDOWN: "Host down",
      ...
      compressed_files_folder: "rkamyp2_uploads_compressed", // dynamically generated and removed again after upload
      term_rows: { default: 13, max: 90, min: 1 },
      help_text:
        "pmkbeta Atom Package Help. Functions:\r\n" +
        ...
        "\r\n" +
        "For more information, take a look at github.com/pycom/pmkbeta-atom or docs.pycom.io\r\n"
    };
  }
  ...
  static settings() {
    return {
      ...
      open_on_start: {
        ...
        title: "Open on start",
        description:
          "Automatically open the pmkbeta console and connect to the board after starting Atom",
        order: 9
      },
      safe_boot_on_upload: {
        type: "boolean",
