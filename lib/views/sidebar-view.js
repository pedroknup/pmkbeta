...
export default class SideBar extends EventEmitter {
  ...
  build(rootElement) {
    ...
    this.button_settings = $('#pmkbeta #settings');
    this.button_settings_sub = $('#pmkbeta #settings .subnav');
    this.settings_project_settings = $('#pmkbeta-project_settings');
    this.settings_global_settings = $('#pmkbeta-global_settings');
    this.settings_auto_connect = $('#pmkbeta-setting-autoconnect');
    ...
    this.buttonPybytes = $('#pmkbeta #pybytes');
