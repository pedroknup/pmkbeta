...
export default class AutoConnect extends EventEmitter {
  constructor(pmkbeta, terminal, settings) {
    super();
    this.terminal = terminal;
    this.pmkbeta = pmkbeta;
  ...
  refreshIpAddresses() {
    ...
    if (addedAddresses) {
      $('#pmkbeta-address-list').removeClass('disabled');
    } else {
      $('#pmkbeta-address-list').addClass('disabled');
      $('#pmkbeta-address-list').html(
